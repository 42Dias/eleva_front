      ...
      >
        <S.RegisterSupplier>
          ...
          <S.ContentSupplierFormCheckbox>
            ...
            >
              <S.CheckContainer>
              <input type="radio" id="30" name="pagamento" value="30" />
                <p>30 dias</p>
              </S.CheckContainer>

              <S.CheckContainer>
              <input type="radio" id="60" name="pagamento" value="60" />
                <p>60 dias</p>
              </S.CheckContainer>

              <S.CheckContainer>
              <input type="radio" id="90" name="pagamento" value="90" />
                <p>90 dias</p>
              </S.CheckContainer>

              <S.CheckContainer>
              <input type="radio" id="120" name="pagamento" value="120" />
                <p>120 dias</p>
              </S.CheckContainer>
            </S.Check>
          </S.ContentSupplierFormCheckbox>
